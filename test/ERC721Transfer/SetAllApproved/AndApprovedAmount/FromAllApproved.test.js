...
contract('ERC721Transfer SetAllApproved AndApprovedAmount FromAllApproved', function(accounts) {
  ...
  describe("to approved", function() {
    describe("with no value", function() {
      describe("transferFrom", function() {
        ...
        shouldBehaviourTransferApproved(owners, approved, allApproved, 0)
      })
      describe("safeTransferFrom", function() {
        before(async function() {
          const token = await createAndMintToken(owners, creators, approved, allApproved)
        ...
        shouldBehaviourSafeTransferApproved(owners, approved, allApproved, 0, null)
      })
      describe("safeTransferFrom(data)", function() {
        before(async function() {
          const token = await createAndMintToken(owners, creators, approved, allApproved)
        ...
        shouldBehaviourSafeTransferApproved(owners, approved, allApproved, 0, data)
      })
    })
    ...
    describe("with value", function() {
      ...
      revertTransfers(owners[0], approved, allApproved, TOKEN_AMOUNT)
    })
  })
})
