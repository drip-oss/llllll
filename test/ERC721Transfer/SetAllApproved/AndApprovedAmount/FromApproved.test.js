...
contract('ERC721Transfer SetAllApproved AndApprovedAmount FromApproved', function(accounts) {
  ...
  describe("to allApproved", function() {
    describe("with no value", function() {
      ...
      revertTransfers(owners[0], allApproved, approved, 0)
    })
    ...
    describe("with value", function() {
      describe("transferFrom", function() {
        ...
        shouldBehaviourTransferApproved(owners, allApproved, approved, TOKEN_AMOUNT)
      })
      describe("safeTransferFrom", function() {
        before(async function() {
          const token = await createAndMintToken(owners, creators, approved, allApproved)
        ...
        shouldBehaviourSafeTransferApproved(owners, allApproved, approved, TOKEN_AMOUNT, null)
      })
      describe("safeTransferFrom(data)", function() {
        before(async function() {
          const token = await createAndMintToken(owners, creators, approved, allApproved)
        ...
        shouldBehaviourSafeTransferApproved(owners, allApproved, approved, TOKEN_AMOUNT, data)
      })
    })
  })
